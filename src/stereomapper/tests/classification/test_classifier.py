...
class TestStereochemicalClassifier:
    ...
    def test_is_enantiomer_valid_case(self):
        ...
        assert StereochemicalClassifier.is_enantiomer(stereo_elements)
    ...
    def test_is_enantiomer_no_tetra_centers(self):
        ...
        assert not StereochemicalClassifier.is_enantiomer(stereo_elements)
    ...
    def test_is_diastereomer_valid_tetra_case(self):
        ...
        assert StereochemicalClassifier.is_diastereomer(stereo_elements)
    ...
    def test_is_diastereomer_with_unspecified(self):
        ...
        assert not StereochemicalClassifier.is_diastereomer(stereo_elements)
    ...
    def test_default_values_handling(self):
        ...
        assert not StereochemicalClassifier.is_enantiomer(empty_stereo_elements)
        assert not StereochemicalClassifier.is_diastereomer(empty_stereo_elements)
        assert not StereochemicalClassifier.is_parent_child(empty_stereo_elements)
    ...
    def test_parent_child_no_stereo(self):
        ...
        assert not StereochemicalClassifier.is_parent_child(stereo_elements)

    def test_parent_child_with_stereo(self):
        """Test is_parent_child returns True when stereochemical elements exist."""
        stereo_elements = {"total_stereo": 3, "missing_centres": 2}
        assert StereochemicalClassifier.is_parent_child(stereo_elements)

    def test_parent_child_all_matched(self):
        """Test is_parent_child returns False when all stereochemical elements match."""
        stereo_elements = {"total_stereo": 2, "missing_centres": 0}
        assert not StereochemicalClassifier.is_parent_child(stereo_elements)
