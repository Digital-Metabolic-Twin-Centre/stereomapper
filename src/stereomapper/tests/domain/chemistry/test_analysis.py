...
class TestProcessingResult:
    ...
    def test_processing_result_creation(self):
        ...
        result = ProcessingResult(
            molecule_id=123, smiles="CCO", error=None, file_path="/path/to/file.sdf"
        )
    ...
    def test_processing_result_default_file_path(self):
        ...
        result = ProcessingResult(molecule_id=123, smiles="CCO", error=None)
...
class TestSimilarityResult:
    ...
    def test_similarity_result_minimal_creation(self):
        ...
        result = SimilarityResult(classification="dissimilar", rmsd=None)
    ...
    def test_similarity_result_frozen(self):
        ...
        result = SimilarityResult(classification="similar", rmsd=0.5)
    ...
    def test_similarity_result_score_property(self):
        ...
        result_with_score = SimilarityResult(
            classification="similar", rmsd=0.5, confidence_score=85
        )
        assert result_with_score.score == 85.0

        # Without confidence_score
        result_no_score = SimilarityResult(classification="similar", rmsd=0.5)
    ...
    def test_similarity_result_to_legacy_tuple(self):
        ...
        # Without confidence_score
        result_no_score = SimilarityResult(classification="dissimilar", rmsd=1.5)
...
class TestPipelineStats:
    ...
    def test_pipeline_stats_success_rate_property(self):
        ...
        # Normal case
        stats = PipelineStats(processed_files=100, successful_molecules=85)
        ...
        perfect_stats = PipelineStats(processed_files=50, successful_molecules=50)
        assert perfect_stats.success_rate == 1.0

        # Zero success rate
        failed_stats = PipelineStats(processed_files=10, successful_molecules=0)
...
class TestModelIntegration:
    ...
    def test_cache_entry_to_processing_result_workflow(self):
        ...
        if cache_entry.is_valid:
            ...
            processing_result = ProcessingResult(
                molecule_id=None, smiles=None, error="Invalid cache entry"
            )
    ...
    def test_frozen_vs_mutable_behavior(self):
        ...
        processing_result = ProcessingResult(molecule_id=1, smiles="C", error=None)

        similarity_result = SimilarityResult(classification="similar", rmsd=0.1)
