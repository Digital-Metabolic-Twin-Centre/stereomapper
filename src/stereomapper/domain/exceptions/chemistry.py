...
from .base import RetryableError, StereomapperError
...
class CanonicalizationError(RetryableError, ChemistryError):
    ...
    def __init__(
        self, message: str, *, tool: Optional[str] = None, timeout: bool = False, **kwargs
    ):
        super().__init__(message, **kwargs)
        if tool:
...
class MoleculeAlignmentError(ChemistryError):
    ...
    def __init__(self, message: str, *, rmsd_attempted: bool = False, **kwargs):
        super().__init__(message, **kwargs)
        if rmsd_attempted:
...
class WildcardMoleculeError(InvalidMoleculeError):
    ...
    def __init__(self, message: str, **kwargs):
        super().__init__(message, validation_type="wildcard_detection", **kwargs)
